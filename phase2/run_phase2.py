...
def main():
    ...
    if not run_command("phase2/phase2_stage1_predictor.py", "Step 1: Evaluating Stage-1 predictor"):
        return
    
    # Step 2: Visualize results
    if not run_command("phase2/phase2_visualize.py", "Step 2: Creating visualizations"):
        return
    ...
    if response == 'y':
        run_command("phase2/phase2_tune_thresholds.py", "Step 3: Tuning thresholds (grid search)")
