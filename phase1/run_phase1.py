...
def main():
    ...
    run_command("phase1/phase1_generate_pages.py", "Step 1: Generating memory pages")
    
    # Step 2: Label pages
    run_command("phase1/phase1_label_pages.py", "Step 2: Compressing and labeling pages")
    
    # Step 3: Visualize
    run_command("phase1/phase1_visualize.py", "Step 3: Creating visualizations")
